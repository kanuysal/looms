            ...
            <div className="row align-items-center">
              <div className="col-xl-2 col-lg-6 col-md-6 col-6">
                <div className="tp-inner-header-logo tp-header-logo">
                  <Link href="/" style={{ fontSize: '24px', fontFamily: 'var(--tp-ff-prisma)', color: transparent ? '#fff' : 'inherit', textTransform: 'uppercase', letterSpacing: '2px' }}>
                    INTERLOOMS
                  </Link>
                </div>
              </div>
              <div className="col-xl-8 col-lg-8 d-none d-xl-block">
                <div className="tp-inner-header-right-wrap text-center">
                  <div className="tp-inner-header-menu header-main-menu">
                    <nav className="tp-main-menu-content d-inline-flex align-items-center">
                      {/* header menus */}
                      <HeaderMenus />
                      {/* header menus */}
                    </nav>
