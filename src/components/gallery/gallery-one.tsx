...
export default function GalleryOne() {
  return (
    <div className="tp-gallery-area fix p-relative" style={{ backgroundColor: '#000' }}>
                  ...
                  {gallery_images.map((g, i) => (
                    ...
                    <div key={i}>
                      <div className="tp-gallery-item mr-30">
                        <Image src={g} alt="gallery-img" style={{ height: '500px', width: '350px', objectFit: 'cover', borderRadius: '20px' }} />
                      </div>
                    </div>
                  ))}
